    ...
    for i in range(number_blocks_width):
        for j in range(number_blocks_width):
            for k in range(number_blocks_width):
                starpu.task_submit()(func_cpu, block_width, matrix_a[j*number_blocks_width+k], matrix_b[k*number_blocks_width+i], matrix_c[j*number_blocks_width+i])
